...
export function forgetMembership(vibeId:string){localStorage.setItem(KEY,JSON.stringify({version:2,memberships:getMemberships().filter(item=>item.vibeId!==vibeId)}));}
